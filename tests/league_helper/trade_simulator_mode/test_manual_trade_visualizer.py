...
class TestDisplayNumberedRoster:
    """Tests for _display_numbered_roster method."""
    ...
    def test_display_empty_roster(self, capsys):
        ...
        manager = TradeSimulatorModeManager(data_folder, player_manager, config)

        # Execute
        manager._display_numbered_roster([], "TEST ROSTER")
    ...
    def test_display_single_player(self, capsys):
        ...
        # Execute
        manager._display_numbered_roster([player], "MY ROSTER")
    ...
    def test_display_multiple_players(self, capsys):
        ...
        # Execute
        manager._display_numbered_roster(players, "TEAM ROSTER")
...
class TestParsePlayerSelection:
    """Tests for _parse_player_selection method."""
    ...
    def test_valid_single_number(self):
        ...
        result = self.manager._parse_player_selection("1", 5)
        assert result == [1]

    def test_valid_multiple_numbers(self):
        """Test parsing valid multiple numbers."""
        result = self.manager._parse_player_selection("1,2,3", 5)
        assert result == [1, 2, 3]
    ...
    def test_exit_lowercase(self):
        ...
        result = self.manager._parse_player_selection("exit", 5)
    ...
    def test_empty_string(self):
        ...
        result = self.manager._parse_player_selection("", 5)
        assert result is None
    ...
    def test_invalid_characters(self):
        ...
        result = self.manager._parse_player_selection("1,a,3", 5)
        assert result is None

    def test_out_of_range_high(self):
        """Test number above max_index returns None."""
        result = self.manager._parse_player_selection("1,99", 5)
        assert result is None

    def test_out_of_range_low(self):
        """Test zero returns None."""
        result = self.manager._parse_player_selection("0,1", 5)
        assert result is None

    def test_negative_number(self):
        """Test negative number returns None."""
        result = self.manager._parse_player_selection("1,-2", 5)
        assert result is None

    def test_duplicate_numbers(self):
        """Test duplicate numbers return None."""
        result = self.manager._parse_player_selection("1,2,1", 5)
        assert result is None
...
class TestGetPlayersByIndices:
    """Tests for _get_players_by_indices method."""
    ...
    def test_extract_single_player(self):
        ...
        result = self.manager._get_players_by_indices(self.roster, [1])
        assert len(result) == 1
        assert result[0].name == "Player One"

    def test_extract_multiple_players(self):
        """Test extracting multiple players by indices."""
        result = self.manager._get_players_by_indices(self.roster, [1, 3])
        assert len(result) == 2
        assert result[0].name == "Player One"
    ...
    def test_non_sequential_order(self):
        ...
        result = self.manager._get_players_by_indices(self.roster, [3, 1, 2])
        assert len(result) == 3
...
class TestDisplayTradeResult:
    """Tests for _display_trade_result method."""
    ...
    def test_display_trade_result(self, capsys):
        ...
        # Execute
        self.manager._display_trade_result(trade, 1000.0, 1000.0)
...
class TestSaveManualTradeToFile:
    """Tests for _save_manual_trade_to_file method."""
    ...
    def test_save_trade_file_created(self, mock_file, mock_datetime):
        ...
        # Execute
        filename = self.manager._save_manual_trade_to_file(trade, "Opponent Team", 1000.0, 1000.0)
    ...
    def test_save_trade_with_spaces_in_name(self, mock_file, mock_datetime):
        ...
        # Execute
        filename = self.manager._save_manual_trade_to_file(trade, "Team With Spaces", 1000.0, 1000.0)
...
class TestDisplayCombinedRoster:
    """Tests for _display_combined_roster method (new in 2025-10-16 redesign)."""
    ...
    def test_combined_roster_returns_boundary(self, capsys):
        ...
        # Execute
        boundary, my_display_order, their_display_order = self.manager._display_combined_roster(my_roster, their_roster, "Opponent Team")
    ...
    def test_combined_roster_organizes_by_position(self, capsys):
        ...
        # Execute
        _, _, _ = self.manager._display_combined_roster(my_roster, their_roster, "Opponent")
...
class TestSplitPlayersByTeam:
    """Tests for _split_players_by_team helper method (new in 2025-10-16 redesign)."""
    ...
    def test_split_all_from_my_team(self):
        ...
        my_indices, their_indices = self.manager._split_players_by_team(unified_indices, roster_boundary)
...
class TestParseUnifiedPlayerSelection:
    """Tests for _parse_unified_player_selection method (new in 2025-10-16 redesign)."""
    ...
    def test_valid_unified_selection(self):
        ...
        result = self.manager._parse_unified_player_selection("2,6,18,21", 26, 14)
    ...
    def test_exit_returns_none(self):
        ...
        result = self.manager._parse_unified_player_selection("exit", 26, 14)
        assert result is None
    ...
    def test_unequal_numbers_returns_none(self):
        ...
        result = self.manager._parse_unified_player_selection("1,2,3,14", 26, 14)
        assert result is None

    def test_all_from_one_team_returns_none(self):
        """Test all selections from one team returns None."""
        # All from my team
        result = self.manager._parse_unified_player_selection("1,2,3,4", 26, 14)
        assert result is None

    def test_invalid_format_returns_none(self):
        """Test invalid format returns None."""
        result = self.manager._parse_unified_player_selection("abc", 26, 14)
        assert result is None

    def test_out_of_range_returns_none(self):
        """Test out of range selection returns None."""
        result = self.manager._parse_unified_player_selection("1,99", 26, 14)
        assert result is None

    def test_minimum_one_from_each_team(self):
        """Test that at least 1 from each team is required."""
        # Valid: 1 from each
        result = self.manager._parse_unified_player_selection("1,14", 26, 14)
        assert result is not None

        # Invalid: 0 from my team
        result = self.manager._parse_unified_player_selection("14,15", 26, 14)
        assert result is None
