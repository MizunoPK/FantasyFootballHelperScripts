...
class TestPerformanceDeviation:
  ...
  "parameters": {
    ...
    "MATCHUP_SCORING": {"IMPACT_SCALE": 150.0, "THRESHOLDS": {"EXCELLENT": 24, "GOOD": 18, "POOR": 12, "VERY_POOR": 6}, "MULTIPLIERS": {"EXCELLENT": 1.0}, "WEIGHT": 1.0},
    "SCHEDULE_SCORING": {"IMPACT_SCALE": 80.0, "THRESHOLDS": {"EXCELLENT": 24, "GOOD": 20, "POOR": 12, "VERY_POOR": 8}, "MULTIPLIERS": {"EXCELLENT": 1.0}, "WEIGHT": 0.0}
  }
}"""
