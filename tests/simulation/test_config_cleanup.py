...
class TestCleanupOldAccuracyOptimalFolders:
    """Tests for cleanup_old_accuracy_optimal_folders function."""
    ...
    def test_no_cleanup_when_under_limit(self, tmp_path):
        ...
        assert deleted == 0
        assert len(list(tmp_path.glob("accuracy_optimal_*"))) == 3
    ...
    def test_respects_custom_limit(self, tmp_path):
        ...
        assert deleted == 3
        assert len(list(tmp_path.glob("accuracy_optimal_*"))) == 1
    ...
    def test_handles_nonexistent_directory(self, tmp_path):
        ...
        deleted = cleanup_old_accuracy_optimal_folders(nonexistent)
