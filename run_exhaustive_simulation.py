...
PARAMETER_RANGES = {
    ...
    "CONSISTENCY_LOW_MULTIPLIER": 0.1,
    "CONSISTENCY_MEDIUM_MULTIPLIER": 0.0,
    "CONSISTENCY_HIGH_MULTIPLIER": 0.1
}
...
PARAMETER_BOUNDS = {
    ...
    "CONSISTENCY_LOW_MULTIPLIER": (1.0, 1.2),
    "CONSISTENCY_MEDIUM_MULTIPLIER": (1.0, 1.0),
    "CONSISTENCY_HIGH_MULTIPLIER": (0.8, 1.0)
}
