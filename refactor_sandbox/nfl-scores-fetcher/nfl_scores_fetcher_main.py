...
from nfl_scores_models import GameScore, WeeklyScores
...
async def main():
    ...
    # Setup logging
    logger = setup_logger(config.LOG_NAME, config.LOGGING_LEVEL, config.LOGGING_TO_FILE, config.LOGGING_FILE, config.LOGGING_FORMAT)
