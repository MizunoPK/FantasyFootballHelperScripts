...
LOGGING_TO_FILE = False          # Default OFF (use --enable-log-file flag to enable file logging)
LOG_NAME = "accuracy_simulation"
# LOGGING_FILE removed - log file path now auto-generated by LoggingManager
