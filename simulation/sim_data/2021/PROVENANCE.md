# 2021 season corpus — provenance and handling
...
draft-time ADP was only Pearson **0.780**, and **5** of FFC's top-50
...
- **205 players** carry FFC draft-time ADP.
- **664 players** carry the undrafted sentinel `200.0`. FFC's sampled drafts never took
...
- **No player was dropped** — every unmatched player sat at or above the saturation point, so all were resolvable as undrafted.
...
**810 records** (45 kickers x 18 weeks) moved from the compiler's `kicking`
