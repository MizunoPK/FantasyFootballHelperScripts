...
# File logging controlled by --enable-log-file CLI flag (default OFF)
# Log file path auto-generated by LoggingManager: logs/win_rate_simulation/{timestamp}.log
...
Examples:
  ...
  python run_simulation.py --baseline my_config.json --output results/test1
    ...
    # Add --enable-log-file flag to main parser (available across all modes)
    parser.add_argument(
        '--enable-log-file',
        action='store_true',
        default=False,
    ...
    # Initialize logging system (after args parsed so --enable-log-file is available)
    # log_to_file controlled by --enable-log-file flag, log_file_path=None for auto-generated path
