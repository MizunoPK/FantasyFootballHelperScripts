...
S2: Feature Deep Dive (loop per feature)
...
S5-S8: Feature Loop (repeat per feature)
...
**Epic Folder:** `feature-updates/KAI-6-nfl_team_penalty/`
...
- `feature_XX_{name}/code_changes.md` - Actual changes
