# STAGE 2: Feature Deep Dive Guide (ROUTER)
...
**Exit Condition:** Stage 2 is complete for a feature when the spec has user-approved acceptance criteria, passes both mandatory gates (Research Completeness Audit + Spec-to-Epic Alignment Check), and has zero unresolved checklist items
...
**When complete:** Feature's Stage 2 is COMPLETE
...
**Stage 2 has THREE mandatory gates that cannot be skipped:**
...
**Cannot proceed to Stage 3 without user approval.**
...
```markdown
I'm starting Stage 2a (Research Phase) for Feature {N}: {Name}.
...
### If you're resuming mid-Stage 2:
...
- Feature's Stage 2 is COMPLETE
- Update epic EPIC_README.md Feature Tracking table
- Proceed to next feature or Stage 3
...
□ **Epic updated:**
  - EPIC_README.md Feature Tracking: "[x]" for this feature's Stage 2
...
The original guide has been preserved for reference but is deprecated. All Stage 2 work should use the new split guides (2a, 2b, 2c).
