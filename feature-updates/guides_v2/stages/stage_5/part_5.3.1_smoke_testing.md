...
**Stage Flow Context:**
```
Phase 5.1 (Implementation Planning) → Phase 5.2 (Implementation) →
→ [YOU ARE HERE: Part 5.3.1 - Smoke Testing] →
→ Part 5.3.2 (QC Rounds) → Part 5.3.3 (Final Review) →
...
- ✅ Ready for Part 5.3.2 (QC Rounds)
...
**Feature-specific rules for Part 5.3.1:**
...
2. ⚠️ If smoke testing fails → Fix issues, restart from Part 1
   ...
   - Do NOT proceed to QC Rounds (Part 5.3.2) until all parts pass
...
**Feature-specific workflow for Part 5.3.1:**
...
Part 3: E2E Execution Test (CRITICAL)
   ...
   ↓
   If PASS → Document, proceed to Part 5.3.2
...
5. Do NOT proceed to Part 5.3.2 until all parts pass
...
- Next stage: QC Rounds for THIS feature (Part 5.3.2)
