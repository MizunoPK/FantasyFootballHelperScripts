# STAGE 3: Cross-Feature Sanity Check Guide
...
1. ⚠️ ALL features must complete Stage 2 before starting Stage 3
   - Check epic EPIC_README.md Feature Tracking table
   - Every feature must show "[x]" in "Stage 2 Complete"
...
6. ⚠️ Cannot proceed to Stage 4 without user approval
...
**Verify BEFORE starting Stage 3:**

□ ALL features have completed Stage 2 - verified in epic EPIC_README.md Feature Tracking table
□ Every feature has:
  - Complete spec.md with all sections filled
  - All checklist.md items resolved (no open questions)
  - Per-feature alignment check performed (Phase 5 of Stage 2)
□ Epic EPIC_README.md shows:
  - Every feature with "[x]" in "Stage 2 Complete" column
  - No features with "Not started" or "In progress" status
□ No blockers or waiting states in any feature README.md

**If any prerequisite fails:**
- ❌ STOP - Do NOT proceed with Stage 3
- Return to Stage 2 for incomplete features
...
1. **Stage 4:** Update epic testing strategy based on this plan
2. **Stage 5:** Implement features sequentially (1, 2, 3, then 4)
...
3. Are you ready to proceed to Stage 4 (Epic Testing Strategy)?
...
- Cannot proceed to Stage 4 without approval
...
Proceeding to Stage 4 (Epic Testing Strategy).
```
...
**Current Step:** Ready to begin Stage 4
**Current Guide:** stages/stage_4/epic_testing_strategy.md
**Guide Last Read:** NOT YET (will read when starting Stage 4)

**Progress:** Stage 3 complete, user approved plan
**Next Action:** Read stages/stage_4/epic_testing_strategy.md and begin epic testing strategy update
**Blockers:** None
...
**Next: Stage 4 (Epic Testing Strategy)**

I'll now transition to Stage 4 to update the epic testing strategy based on our detailed plan.

Following `stages/stage_4/epic_testing_strategy.md` to update epic_smoke_test_plan.md with specific test scenarios and integration points.
```
...
□ Epic EPIC_README.md updated:
  - Epic Completion Checklist: Stage 3 items checked
  - Agent Status: Phase = TESTING_STRATEGY, ready for Stage 4
...
❌ "Let me start Stage 4 while waiting for approval"
   ✅ STOP - Cannot proceed without approval

❌ "One feature isn't done with Stage 2 yet, but I'll start Stage 3"
   ✅ STOP - ALL features must complete Stage 2 first
```
...
7. ⚡ After marking Stage 3 complete (Step 6)

---

## Prerequisites for Stage 4

**Before transitioning to Stage 4, verify:**

□ Stage 3 completion criteria ALL met
...
**Next Guide:** `stages/stage_4/epic_testing_strategy.md`
...
**Remember:** Use the phase transition prompt from `prompts_reference_v2.md` when starting Stage 4.

---

*End of stages/stage_3/cross_feature_sanity_check.md*
