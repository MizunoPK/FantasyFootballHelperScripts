...
- Smoke Testing (S5.P5) Part 3 discovers issues
- QC Rounds (S5.P6) any round discovers issues
- Epic Smoke Testing (S6.P1) discovers issues
- Epic QC Rounds (S6.P2) discovers issues
...
- **Feature-level:** Issues discovered during S5.P5 (Smoke Testing) or S5.P6 (QC Rounds) for a specific feature
...
**Testing Stage Paused:** {S6.P1 Epic Smoke Step 2 / S6.P2 Epic QC Round 1 / Stage 7 User Testing}
...
- Loop back to S6.P1 after all issues resolved
- User verification required for each issue
```
...
**Source:** {Feature/Epic}
**Testing Stage:** {S5.P5 Smoke Testing / S5.P6 QC Rounds / Stage 6 Epic Testing / Stage 7 User Testing}
...
**Testing Stage to Loop Back To:** {S5.P5 Step 1 / S6.P1 Step 1}
...
**When to use:**
- Issues discovered during S5.P5 (Smoke Testing) for THIS feature
- Issues discovered during S5.P6 (QC Rounds) for THIS feature
...
**Loop-back destination:** S5.P5 Step 1 (Smoke Testing)
...
**When to use:**
- Issues discovered during S6.P1 (Epic Smoke Testing)
- Issues discovered during S6.P2 (Epic QC Rounds)
...
**Loop-back destination:** S6.P1 Step 1 (Epic Smoke Testing)
...
7. After all bugs fixed: Loop back to S6.P1 (NOT Stage 7)
