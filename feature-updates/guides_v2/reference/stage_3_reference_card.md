...
**Location:** stages/stage_3/cross_feature_sanity_check.md Step 5
**What it checks:**
...
|------------------|---------------|
| Starting cross-feature sanity check | stages/stage_3/cross_feature_sanity_check.md |
| Need comparison examples | stages/stage_3/cross_feature_sanity_check.md (examples section) |
| Conflict resolution patterns | stages/stage_3/cross_feature_sanity_check.md (Step 3) |
