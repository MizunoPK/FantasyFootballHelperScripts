...
**Ask yourself:**
1. Did I check ALL 16 dimensions across all 4 sub-rounds? (Yes/No)
...
|-------|----------------------|-----------|
| 1.0 | **Complete** | ✅ All 16 dimensions checked<br>✅ All 4 sub-rounds completed<br>✅ Root files checked (README.md, EPIC_WORKFLOW_USAGE.md, prompts_reference_v2.md)<br>✅ All directories searched (stages/, templates/, reference/, dimensions/)<br>✅ No intentional exclusions |
| 0.8 | **Mostly Complete** | ✅ All 16 dimensions checked<br>✅ All 4 sub-rounds completed<br>⚠️ Root files partially checked<br>✅ Main directories searched<br>⚠️ Minor directories skipped (examples/) |
| 0.6 | **Partial** | ⚠️ 12-15 dimensions checked<br>✅ All 4 sub-rounds completed<br>❌ Root files not specifically checked<br>✅ stages/ directory checked<br>⚠️ Some directories skipped |
| 0.4 | **Incomplete** | ❌ <12 dimensions checked<br>⚠️ Some sub-rounds skipped<br>❌ Root files not checked<br>⚠️ Only stages/ directory checked |
| 0.2 | **Minimal** | ❌ <8 dimensions checked<br>❌ Sub-rounds not followed<br>❌ Root files excluded<br>❌ Only subset of directories |
...
**Coverage Questions:**
1. Did I check ALL 16 dimensions? ___
...
**Example:**
```text
Coverage: 1.0 (all 16 dimensions, all directories, root files)
...
```text
Coverage: 1.0 (all 16 dimensions, all directories, root files checked)
