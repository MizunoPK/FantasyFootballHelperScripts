...
class TradeFileWriter:
    ...
    def _build_side_by_side_row(
        ...
        single_value_components = [
            ...
            ('ADP Mult', 'ADP Multiplier', float, 4),
            ('Player Rating', 'Player Rating', str, None),
            ('Player Mult', 'Player Rating Multiplier', float, 4),
            ('Team Quality', 'Team Quality', str, None),
            ('Team Mult', 'Team Quality Multiplier', float, 4),
            ('Performance', 'Performance', str, None),
            ('Perf %', 'Perf %', str, None),
            ('Perf Mult', 'Performance Multiplier', float, 4),
